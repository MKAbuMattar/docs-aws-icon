...
import { filterIt } from '@/components/ReactPageMain_2.1.1/utils/filterIt.util';
import { initialItems } from '@/components/ReactPageMain_2.1.1/utils/initialItems.util';
import Card from '@/components/ReactPageMain_2.1.1/Card';

import {
  Cards,
  SearchInput,
  SearchSection,
} from '@/components/ReactPageMain_2.1.1/style';
