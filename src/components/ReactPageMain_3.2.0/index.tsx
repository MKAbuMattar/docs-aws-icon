...
import { filterIt } from '@/components/ReactPageMain_3.2.0/utils/filterIt.util';
import { initialItems } from '@/components/ReactPageMain_3.2.0/utils/initialItems.util';
import Card from '@/components/ReactPageMain_3.2.0/Card';

import {
  Cards,
  SearchInput,
  SearchSection,
} from '@/components/ReactPageMain_3.2.0/style';
